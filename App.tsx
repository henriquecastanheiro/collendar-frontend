...
function Navigation() {
  ...
  const [selectedCalendario, setSelectedCalendario] =
    useState<Calendario | null>(null);
  const [editingCalendario, setEditingCalendario] = useState<Calendario | null>(
    null
  );
    ...
    case "calendarioDetail":
      return (
        <CalendarioDetailScreen
          ...
          onEdit={(c: Calendario) => navigate("calendarioForm", c)}
          onCreateEvento={() => navigate("eventoForm")}
          onEditEvento={(e: Evento) => navigate("eventoForm", e)}
          onCompartilhar={(c: Calendario) => navigate("compartilhar", c)}
        />
      );
    case "calendarioForm":
      return (
    ...
    default:
      return (
        <HomeScreen
          ...
          onSelectCalendario={(c: Calendario) =>
            navigate("calendarioDetail", c)
          }
